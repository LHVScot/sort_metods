...
elif sort_metod == "shake" and sort_size == 100000:
    a = []
    for i in range(100000):
        i = random.randint(1,100)
        a.append(i)
...
# bubble sort
elif sort_metod == "bubble" and sort_size == 1000:
    a = []
    for i in range(1000):
        i = random.randint(1,100)
        a.append(i)
    
    sorted_nums, swaps = bubble_sort(a)

    print("Отсортированный список:", sorted_nums)
    print("Количество перестановок:", swaps)

elif sort_metod == "bubble" and sort_size == 10000:
    a = []
    for i in range(10000):
        i = random.randint(1,100)
        a.append(i)
...
elif sort_metod == "bubble" and sort_size == 100000:
    a = []
    for i in range(100000):
        i = random.randint(1,100)
        a.append(i)
    ...
    print("Количество перестановок:", swaps)
#insertion sort
elif sort_metod == "insertion" and sort_size == 1000:
    a = []
    for i in range(1000):
        i = random.randint(1,100)
        a.append(i)
    count_swaps = insertion_sort(a)
    print("Отсортированный список:", a)
    print("Количество перестановок:", count_swaps)

elif sort_metod == "insertion" and sort_size == 10000:
    a = []
    for i in range(10000):
        i = random.randint(1,100)
        a.append(i)
...
elif sort_metod == "insertion" and sort_size == 100000:
    a = []
    for i in range(100000):
        i = random.randint(1,100)
        a.append(i)
    ...
    print("Количество перестановок:", count_swaps)
#selection sort
elif sort_metod == "selection" and sort_size == 1000:
    a = []
    for i in range(1000):
        i = random.randint(1,100)
        a.append(i)
...
elif sort_metod == "selection" and sort_size == 10000:
    a = []
    for i in range(10000):
        i = random.randint(1,100)
        a.append(i)
...
elif sort_metod == "selection" and sort_size == 100000:
    a = []
    for i in range(100000):
        i = random.randint(1,100)
        a.append(i)
    ...
    print(f"Количество перестановок: {swap_count}")
#merge sort
elif sort_metod == "merge" and sort_size == 1000:
    a = []
    for i in range(1000):
        i = random.randint(1,100)
        a.append(i)
    merge_sort(a)
    sorted_nums, inversions = merge_sort(a)

    print("Отсортированный список:", sorted_nums)
    print("Количество перестановок:", inversions)

elif sort_metod == "merge" and sort_size == 10000:
    a = []
    for i in range(10000):
        i = random.randint(1,100)
        a.append(i)
...
elif sort_metod == "merge" and sort_size == 100000:
    a = []
    for i in range(100000):
        i = random.randint(1,100)
        a.append(i)
